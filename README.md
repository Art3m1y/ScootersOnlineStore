...
* Password: admin
 ...
 + For run backend part of project     :
  ...
  _If you have followed all the steps, the frontend will be available at http://__yourhost__:3000 and the backend will be available at http://__yourhost__:8080_
 ### Backend endpoints
