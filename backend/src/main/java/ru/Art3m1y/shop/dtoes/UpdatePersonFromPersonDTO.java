...
@Schema(name = "Модель передачи данных для обновления информации о пользователе со стороны самого пользователя", description = "Используется для удаления не нужных полей из основной модели Person")
@Getter
@Setter
public class UpdatePersonFromPersonDTO {
