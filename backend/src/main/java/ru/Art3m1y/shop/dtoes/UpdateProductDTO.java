...
@Schema(name = "Модель передачи данных для обновления продукта", description = "Используется для удаления не нужных полей из основной модели Product")
@Getter
@Setter
public class UpdateProductDTO {
    ...
    @Max(value = 25, message = "Максимальное значение времени работы самоката равно 30 часам")
    private byte time;
}
